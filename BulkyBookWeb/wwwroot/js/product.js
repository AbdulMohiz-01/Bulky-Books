                ...
                "render": function (data) {
                    ...
                    return `
                        <div class="btn-group w-100" width="20%" role="group">
                            <a href="/Admin/Product/Upsert?id=${data}" class="btn btn-info m-0 w-50"> <i class="bi bi-pencil-square"></i> &nbsp; Edit</a>
                            <a onClick=Delete('/Admin/Product/Delete/${data}') class="btn btn-danger m-0 w-50"><i class="bi bi-trash"></i> &nbsp; Delete</a>
                        </div>
                    `
                },
                "width": "15%"
